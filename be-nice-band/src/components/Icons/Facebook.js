// icon:facebook-circle-line | Remix Icon https://remixicon.com/ | Remix Design
import * as React from "react";

function IconFacebookCircleLine() {
  return (
    <svg viewBox="0 0 36 36" height="1.5em" width="1.5em" class="text-white fill-current hover:text-gray-400 fill-current">
